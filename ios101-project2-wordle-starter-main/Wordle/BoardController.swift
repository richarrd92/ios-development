...
class BoardController: NSObject,
  ...
  private func applyNumLettersSettings(with settings: [String: Any]) {
    ...
    // ...
      ...
      print("number of column box", numItemsPerRow)
    // END YOUR CODE HERE
  }
  ...
  private func applyNumGuessesSettings(with settings: [String: Any]) {
    ...
    // ...
      ...
      print("In the number of guess function", settings)
    // END YOUR CODE HERE
  }
  ...
  private func applyThemeSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      print("Settings before theme change: \(settings)")
      ...
      print("Settings after theme change: \(settings)")
    // END YOUR CODE HERE
  }
  ...
  private func applyIsAlienWordleSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      if let isAlienWordleString = settings[kIsAlienWordleKey] as? String,
      let isAlienWordle = Bool(isAlienWordleString) {
          self.isAlienWordle = isAlienWordle
          print("Is alien wordle: \(isAlienWordle)")
      }
    // START YOUR CODE HERE
  }
}
