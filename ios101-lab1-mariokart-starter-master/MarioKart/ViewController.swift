...
class ViewController: UIViewController,
  ...
  @IBAction func didDoubleTapKart(_ sender: UITapGestureRecognizer) {
    ...
    // YOUR CODE HERE
      ...
      print("Kart is moving forward") // debug statement -> print after double-click
//      translate(kart: sender.view, by: view.frame.width) // kart stays out of screen
    ...
    // YOUR CODE HERE
      translate(kart: sender.view, by: view.frame.width) {
        self.translate(kart: sender.view, by: -self.view.frame.width) // returns kart to orginal position
      }
  }
  ...
  @IBAction func didRotateKart(_ sender: UIRotationGestureRecognizer) {
    ...
    // YOUR CODE HERE
    print("Kart is rotating") // debug statement
...
//      runStartingAnimationsAllAtOnce() // animates all at once
      runStartingAnimationsOneByOne{
//          self.raceKartsWithSameSpeed() // optional argument - karts race with same speed
          self.raceKartsWithRandomizedSpeed() // optional argument - karts race with random speeds
      } // animates one by one
  }
  ...
  private func runStartingAnimationsAllAtOnce() {
    // YOUR CODE HERE
      // all karts start at the same time
